    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4" onClick={onClose}>
        <motion.div 
          ...
          className="bg-bg-card border border-border-primary rounded-[24px] w-full max-w-lg overflow-hidden shadow-2xl"
          ...
          <div className="p-6 sm:p-8 flex flex-col gap-6">
            <div className="flex justify-between items-start gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button className="p-2 rounded-xl bg-bg-secondary text-text-muted hover:text-rose-400 hover:bg-rose-500/10 transition-all" onClick={onClose}>
                  <X size={18}/>
                </button>
              </div>
            </div>
